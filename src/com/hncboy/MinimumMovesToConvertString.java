...
/**
 * @author hncboy
 * @date 2021/10/3 12:19
 * @description 5890.转换字符串的最少操作次数
 * 
...
public class MinimumMovesToConvertString {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(m.minimumMoves("XXX") == 1);
        System.out.println(m.minimumMoves("XXOX") == 2);
        System.out.println(m.minimumMoves("OOOO") == 0);
    }
