 ...
 *
 * 注意：本题与主站 173 题 {@link com.hncboy.BinarySearchTreeIterator} 相同： https://leetcode-cn.com/problems/binary-search-tree-iterator/
 * 通过次数 3,385 提交次数 3,842
 *
 * 来源：力扣（LeetCode）
...
public class Question055 {
    ...
    private static class BSTIterator {
        ...
        public int next() {
            return treeList.get(current++);
        }

        public boolean hasNext() {
            return current < treeList.size();
        }
