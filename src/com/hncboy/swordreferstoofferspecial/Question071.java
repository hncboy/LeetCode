 ...
 *
 * 注意：本题与主站 528 题 {@link com.hncboy.RandomPickWithWeight} 相同： https://leetcode-cn.com/problems/random-pick-with-weight/
 * 通过次数 2,311 提交次数 4,574
 *
 * 来源：力扣（LeetCode）
...
public class Question071 {
    ...
    private static class Solution {
        ...
        public int pickIndex() {
            int target = (int) (Math.random() * sum[sum.length - 1]) + 1;
            int left = 1;
